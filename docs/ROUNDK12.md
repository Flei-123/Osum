...
Fünf Aufrufe, **1400 bis 1404**:

| Nr | Aufruf | braucht |
|---|---|---|
| 1400 | `vm_create(gast, rechte)` → Handle | — |
| 1401 | `vm_run(h)` → Grund des Anhaltens | `R_WRITE` |
| 1402 | `vm_stat(h, aus)` | `R_INSPECT` |
| 1403 | `vm_kill(h)` | `R_MANAGE` |
| 1404 | `vm_value(h, nr)` | `R_READ` |
