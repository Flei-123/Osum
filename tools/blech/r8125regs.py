...
"""tools/blech/r8125regs.py -- HAELT DEN 8125-ZWEIG GEGEN LINUX.
...
======
    ...
    python3 tools/blech/r8125regs.py             # gegen /tmp/r8169_linux.c
    python3 tools/blech/r8125regs.py --fetch     # laedt r8169_main.c neu
    python3 tools/blech/r8125regs.py --src DATEI
