...
# tools/blech2/lauf.sh -- EIN SCHREIBTISCHLAUF MIT USB-MAUS UND QMP-STROM.
#
#   bash tools/blech2/lauf.sh <ausgabeverzeichnis> <osum.mb> <root.img> \
...
# wartet, bis die Taskleiste steht, laesst tools/blech2/maus.py den
...
sleep 2
python3 tools/blech2/maus.py "$AUS/qmp.sock" "$SEK" "$HZ" \
