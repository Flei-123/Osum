...
# tools/konto/dbg.sh -- die kurze Schleife zum Suchen von Fehlern.
#
...
#
#   bash tools/konto/dbg.sh 'konto anmelden --anbieter jarvis ...'
#
...
if [ "${NETZ:-1}" = "1" ]; then
    ...
    ip netns exec "$NS" python3 tools/konto/attrappe.py --port 8443 \
