...
# tools/hardening/run.sh -- RUNDE HAERTUNG-2, BEFUND 1: buf_grow BEI OOM.
#
#   bash tools/hardening/run.sh
#
# ======================================================================
...
cp tools/hardening/kanarie.fi "$TMPD/kanarie.fi"
cp tools/hardening/proof.fi "$TMPD/nachweis.fi"
