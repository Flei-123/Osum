...
# tools/bridge2/echtstart.sh -- WAS BEIM ERSTEN ECHTEN BOOT PASSIERT
#
#   bash tools/bridge2/echtstart.sh [arbeitsordner]
#
...
cp "$WURZEL" "$W/a.img"
# Die Wurzel als PLATTE, wie tools/bridge2/abriss.sh es tut -- mit
