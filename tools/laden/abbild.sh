...
# tools/laden/abbild.sh -- DIE PLATTE, MIT DER DIESE RUNDE GEMESSEN WIRD.
#
#   bash tools/laden/abbild.sh [arbeitsverzeichnis]
#
...
#
#   /bin/*                   die Programme aus tools/laden/build.sh
...
printf '# taskbar.conf -- tools/laden/abbild.sh\nedge=bottom\nheight=28\nwidth=104\nautohide=0\nontop=1\nalign=left\n' > "$P/taskbar.conf"
